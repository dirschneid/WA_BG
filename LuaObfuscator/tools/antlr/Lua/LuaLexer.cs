...
// $ANTLR 3.4.1.9004 Lua.g 2011-10-14 15:54:56
...
public partial class LuaLexer : Antlr.Runtime.Lexer
{
	...
	private void mNAME()
	{
		...
		try
		{
			int _type = NAME;
			int _channel = DefaultTokenChannel;
			// Lua.g:99:6: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( options {greedy=true; } : 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
			DebugEnterAlt(1);
			// Lua.g:99:7: ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( options {greedy=true; } : 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
			{
			DebugLocation(99, 7);
			...
			DebugLocation(99, 30);
			// Lua.g:99:30: ( options {greedy=true; } : 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
	...
	private void mEXP()
	{
		...
		try
		{
			int _type = EXP;
			int _channel = DefaultTokenChannel;
			// Lua.g:106:5: ( ( INT | FLOAT ) ( 'E' | 'e' ) ( '-' )? INT )
			DebugEnterAlt(1);
			// Lua.g:106:7: ( INT | FLOAT ) ( 'E' | 'e' ) ( '-' )? INT
			{
			DebugLocation(106, 7);
			// Lua.g:106:7: ( INT | FLOAT )
			int alt3=2;
	...
	private void mHEX()
	{
		...
		try
		{
			int _type = HEX;
			int _channel = DefaultTokenChannel;
			// Lua.g:108:5: ( '0x' ( '0' .. '9' | 'a' .. 'f' )+ )
			DebugEnterAlt(1);
			// Lua.g:108:6: '0x' ( '0' .. '9' | 'a' .. 'f' )+
			{
			DebugLocation(108, 6);
			Match("0x"); 

			DebugLocation(108, 11);
			// Lua.g:108:11: ( '0' .. '9' | 'a' .. 'f' )+
			int cnt5=0;
	...
	private void mNORMALSTRING()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// Lua.g:113:5: ( '\"' ( EscapeSequence |~ ( '\\\\' | '\"' ) )* '\"' )
			DebugEnterAlt(1);
			// Lua.g:113:8: '\"' ( EscapeSequence |~ ( '\\\\' | '\"' ) )* '\"'
			{
			DebugLocation(113, 8);
			Match('\"'); 
			DebugLocation(113, 12);
			// Lua.g:113:12: ( EscapeSequence |~ ( '\\\\' | '\"' ) )*
	...
	private void mCHARSTRING()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// Lua.g:117:4: ( '\\'' ( EscapeSequence |~ ( '\\'' | '\\\\' ) )* '\\'' )
			DebugEnterAlt(1);
			// Lua.g:117:6: '\\'' ( EscapeSequence |~ ( '\\'' | '\\\\' ) )* '\\''
			{
			DebugLocation(117, 6);
			Match('\''); 
			DebugLocation(117, 11);
			// Lua.g:117:11: ( EscapeSequence |~ ( '\\'' | '\\\\' ) )*
	...
	private void mLONGSTRING()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// Lua.g:121:2: ( '[' ( '=' )* '[' ( EscapeSequence |~ ( '\\\\' | ']' ) )* ']' ( '=' )* ']' )
			DebugEnterAlt(1);
			// Lua.g:121:4: '[' ( '=' )* '[' ( EscapeSequence |~ ( '\\\\' | ']' ) )* ']' ( '=' )* ']'
			{
			DebugLocation(121, 4);
			Match('['); 
			DebugLocation(121, 7);
	...
	private void mEscapeSequence()
	{
		...
		try
		{
			// Lua.g:127:5: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UnicodeEscape | OctalEscape )
			int alt11=3;
	...
	private void mOctalEscape()
	{
		...
		try
		{
			// Lua.g:134:5: ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) )
			int alt12=3;
	...
	private void mUnicodeEscape()
	{
		...
		try
		{
			// Lua.g:141:5: ( '\\\\' 'u' HexDigit HexDigit HexDigit HexDigit )
			DebugEnterAlt(1);
			// Lua.g:141:9: '\\\\' 'u' HexDigit HexDigit HexDigit HexDigit
			{
			DebugLocation(141, 9);
			Match('\\'); 
	...
	private void mCOMMENT()
	{
		...
		try
		{
			int _type = COMMENT;
			int _channel = DefaultTokenChannel;
			// Lua.g:148:5: ( '--[[' ( options {greedy=false; } : . )* ']]' )
			DebugEnterAlt(1);
			// Lua.g:148:9: '--[[' ( options {greedy=false; } : . )* ']]'
			{
			DebugLocation(148, 9);
			Match("--[["); 

			DebugLocation(148, 16);
			// Lua.g:148:16: ( options {greedy=false; } : . )*
	...
	private class DFA3 : DFA
	{
		...
		public override string Description { get { return "106:7: ( INT | FLOAT )"; } }
